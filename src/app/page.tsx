...
import Turnos from "./gestao/turnos/page";
    ...
    const loadDashboardData = () => {
      ...
      EventosAtivosService.getEventosAtivos()
        ...
        .finally(() => {
          ...
          console.log("VER:" + TurnosAtivosService.getTurnosAtivos());
          TurnosAtivosService.getTurnosAtivosPorPessoa(currentUser ? currentUser.id : "")
            .then(turnos => {
              setMeusTurnos(turnos);
              console.log("Meus turnos carregados:", turnos);
            })
            .catch(error => {
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <span className="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-medium rounded-full">
                          {Math.ceil(
                            (new Date(evento.dataInicio).getTime() - new Date().getTime()) /
                              (1000 * 60 * 60 * 24)
                          )}{" "}
                          dias
                        </span>
            ...
            {eventos.length === 0 && (
              <div className="bg-white rounded-lg shadow-sm p-12 text-center">
                ...
                <p className="text-gray-500 mb-6">
                  Comece por criar o seu primeiro evento para gerir turnos e participantes.
                </p>
                <Link
                  href="/eventos"
